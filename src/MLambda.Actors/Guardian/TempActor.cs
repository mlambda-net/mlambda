// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TempActor.cs" company="MLambda">
...
namespace MLambda.Actors.Guardian
{
    ...
    /// <summary>
    /// The temporary guardian actor that parents temporary actors used for ask pattern.
    /// </summary>
    [Route("temp")]
    public class TempActor : Actor
    {
        /// <summary>
