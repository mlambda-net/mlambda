...
namespace MLambda.Actors.Remote.Satellite
{
    using System;
    ...
    public class SatelliteService : ISatelliteService
    {
        ...
        public void Start()
        {
            ...
            this.systemContext.Spawn<WorkerActor>().Wait();
            this.systemContext.Spawn<ActorResolverActor>().Wait();
