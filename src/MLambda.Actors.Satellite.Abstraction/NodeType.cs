...
namespace MLambda.Actors.Satellite.Abstraction
{
    ...
    public enum NodeType
    {
        ...
        /// <summary>
        /// An asteroid node that connects to the cluster as a lightweight client.
        /// Does not run user actors; routes all messages through a local DispatcherActor
        /// using round-robin cluster selection.
        /// </summary>
        Asteroid,
    }
}
