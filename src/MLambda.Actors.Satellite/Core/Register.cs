...
namespace MLambda.Actors.Satellite.Core
{
    using System;
    ...
    public static class Register
    {
        ...
        public static IServiceCollection AddSatelliteActor(this IServiceCollection services)
        {
        ...
        public static IActorCatalog BuildSatelliteNode(
            ...
            Action<ActorCatalogConfig> configure)
        {
            ...
            if (fortressConfig.Enabled)
            {
                if (isCluster)
                {
                    services.AddFortress(fortressConfig);
                }
                else
                {
            ...
            if (isSatellite)
            {
                ...
                // Hybrid nodes self-register locally via ActorCatalog.
            ...
            return new ActorCatalog(provider);
        }
    }
}
